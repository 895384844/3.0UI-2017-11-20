define(
	function () {
		return ['$scope', 'HttpService', 'SystemService','title','userInfo','close', WarningDeviceEditCtrl];
		function WarningDeviceEditCtrl($scope, HttpService,SystemService,title, userInfo,close) {
