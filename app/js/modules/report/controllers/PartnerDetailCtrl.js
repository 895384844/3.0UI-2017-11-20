define(
	function () {
		return ['$scope', 'HttpService','$http', 'SystemService','row','data','GridService','GetLocalTime','close', PartnerDetailCtrl];
		function PartnerDetailCtrl($scope, HttpService,$http,SystemService,row,data,GridService, GetLocalTime,close) {			
